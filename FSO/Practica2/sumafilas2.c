...
void inicia_filas(struct FILA * pf, int i) {//modificado para requerir el puntero
    int j;
...
int main() { 
    ...
    for (i = 0; i < NUM_FILAS; i++) {
        ...
        pFila = &filas[i]; //asignar el valor de la direcció de la estructura deseada al puntero
        inicia_filas(pFila, i);
